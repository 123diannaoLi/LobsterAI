...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    htmlShareSuccessMessage: '分享链接和分享码已复制到剪贴板。',
    ...
    htmlShareUpdatedMessage: '原分享已更新，链接和分享码已复制到剪贴板。',
  ...
  en: {
    ...
    htmlShareSuccessMessage: 'The share link and code have been copied to the clipboard.',
    ...
    htmlShareUpdatedMessage: 'The share has been updated, and the link and code were copied.',
