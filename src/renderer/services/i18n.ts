...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    copied: '已复制',
    copyrightHolder: 'Longcheer 版权所有',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'LongClaw 服务说明',
    privacyDialogDesc: '在使用 LongClaw 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'LongClaw 服务说明',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用 LongClaw',
    welcomeSubtitle: '已为你配置 Longcheer 内网模型',
    welcomePromo: '使用企业内网模型，无需额外登录',
    welcomeLogin: '登录',
  ...
  en: {
    ...
    copied: 'Copied',
    copyrightHolder: 'Longcheer. All rights reserved.',
    ...
    // Privacy dialog
    privacyDialogTitle: 'LongClaw Service Notes',
    privacyDialogDesc:
      'Before using LongClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'LongClaw Service Notes',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to LongClaw',
    welcomeSubtitle: 'Longcheer internal models are configured',
    welcomePromo: 'Use enterprise internal models without extra login',
    welcomeLogin: 'Login',
